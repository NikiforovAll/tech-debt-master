...
/// <summary>
/// MCP Prompt type for providing structured prompts for technical debt analysis workflows
/// </summary>
[McpServerPromptType]
public static class TechDebtMcpPrompts
{
    [
        McpServerPrompt(Name = "tdm-work-on-debt"),
...
#pragma warning disable S3400 // Methods should not return constants
    public static string TechDebtWorkflowPrompt() =>
